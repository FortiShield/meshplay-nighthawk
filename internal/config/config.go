...
import (
	...
	"github.com/khulnasoft/meshplay-adapter-library/common"
...
const (
	...
	OAMAdapterNameMetadataKey       = "adapter.meshplay.khulnasoft.com/name"
	OAMComponentCategoryMetadataKey = "ui.meshplay.khulnasoft.com/category"
)

var (
	PerfOperation = "meshplay-nighthawk"
