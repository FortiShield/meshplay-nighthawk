...
func init() {
	...
	AllVersions, _ = utils.GetLatestReleaseTagsSorted("meshplay", "meshplay-nighthawk")
	if len(AllVersions) == 0 {
		return
	}
	LatestVersion = AllVersions[len(AllVersions)-1]
	DefaultGenerationMethod = adapter.Manifests
	DefaultGenerationURL = "https://raw.githubusercontent.com/meshplay/meshplay-nighthawk/" + LatestVersion + "/manifests/charts/crds.yaml"
}
